          ...
          <div class="flex flex-col items-center">
            ...
            <form @submit.prevent="onSubmit" id="myform">
              ...
              <div class="lg:flex justify-between items-center mt-4">
                ...
                >
                <VButton label="Get started" class="w-[150px]" @click="onSubmit" :loading="loading" />
              </div>
            </form>
          </div>
        </div>
...
const onSubmit = async () => {
  ...
  unity.value = rate2 ?? 0
  form2.value.amount =  form1.value.amount * rate2
  if (rate1 && rate2) {
    const result = form1.value.amount * rate2
